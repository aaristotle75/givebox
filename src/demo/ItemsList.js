  ...
  formatTableData() {
    ...
    if (!util.isEmpty(data)) {
      data.forEach(function(value, key) {
        ...
        options.push(
          <div>
            <ModalRoute  id={modalID} component={() => loadComponent('modal/common/Delete', { useProjectRoot: false, props: { id: value.ID, resource: 'orgBankAccount', desc: desc, modalID: modalID, match: routeProps.match } })} effect='3DFlipVert' style={{ width: '50%' }} />
